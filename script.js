...
function openDailyRecordEditModal(recordId) {
  ...
  dailyEditMeta.textContent = `كود: ${record.studentCode || '-'} — الصف: ${record.classGrade || '-'} — المدرس: ${record.teacherName || '-'} — بتاريخ: ${record.registrationDate || '-'}${record.registrationTime ? ` (${record.registrationTime})` : ''}`;
