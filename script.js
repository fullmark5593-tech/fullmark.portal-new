          ...
          .map((record) => {
            ...
            return `
              <div class="daily-record-row">
                ...
                <span>سعر الحصة: ${formatCurrency(lessonPrice)} | المتبقي: ${formatCurrency(remainingPrice)} | سعر الكتاب: ${formatCurrency(bookPrice)} | متبقي الكتاب: ${formatCurrency(bookRemainingPrice)}</span>
              </div>
            `;
          })
          .join('')}
